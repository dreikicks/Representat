window.onload = function () {
    ...
    tu.innerHTML="Quins ulls vols " + nuv + "?";
    tc.innerHTML="Quin cabell et posem " + nuv + "?";
    tri.innerHTML="Quina roba interior t'agrada " + nuv + "?";
    trd.innerHTML="Quina part de dalt prefereixes " + nuv + "?";
    trb.innerHTML="Tria ara una part de baix " + nuv + ".";
    tcom.innerHTML="Quin complement et pot quedar millor " + nuv + "?";
    ts.innerHTML="Per finalitzar, quines sabates t'agraden més " + nuv + "?";
    ...
    txtfin.innerHTML="Gaudeix-lo " + nomus;
